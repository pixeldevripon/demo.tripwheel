...
- [ ] Account area contents beyond bookings: invoices and saved tours (per the login mockup success state; account-pages review 9a keeps invoices out of v1 until an invoice template is specced)
