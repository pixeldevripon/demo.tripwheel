...
> **Status: in progress — F1/F2/F3 landed 2026-08-10 (PR-1), F4 (PR-2), F5 (PR-3), F6 (PR-4) and F7 (PR-5, baseline recorded) same day; F8–F11 open.** Scope: the seat-claim/release
