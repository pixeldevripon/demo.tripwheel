  ...
  const translations: TripTranslation[] = [
    {
      ...
      localTipTitle: en.localTipTitle,
      localTipBody: en.localTipBody,
...
const SEEDS: TripSeed[] = [
  {
    ...
    copy: {
      en: {
        ...
        localTipTitle: 'Claim the front netting',
        localTipBody: 'It has the best unobstructed view for sunset photos.',
  ...
  },
  {
    ...
    copy: {
      en: {
        ...
        localTipTitle: 'Pick the morning slot',
        localTipBody: 'The water is calmest and visibility is best before midday.',
  ...
  },
  {
    ...
    copy: {
      en: {
        ...
        localTipTitle: 'Pack a windbreaker',
        localTipBody: 'The summit is breezy and cool at dawn before the sun climbs.',
  ...
  },
  {
    ...
    copy: {
      en: {
        ...
        localTipTitle: 'Snorkel near the lighthouse',
        localTipBody: 'That stretch has the clearest water and the most sea life.',
  ...
  },
  {
    ...
    copy: {
      en: {
        ...
        localTipTitle: 'Take a middle-row seat',
        localTipBody: 'The ride is smoothest away from the front and rear axles.',
  ...
  },
  {
    ...
    copy: {
      en: {
        ...
        localTipTitle: 'Arrive early for the bow',
        localTipBody: 'The bow seats fill up fast and have the best open views.',
  ...
  },
  {
    ...
    copy: {
      en: {
        ...
        localTipTitle: 'Stand at the Maho fence',
        localTipBody: 'It is the spot for the famous low-flying plane photos.',
  ...
  },
  {
    ...
    copy: {
      en: {
        ...
        localTipTitle: 'Come early afternoon',
        localTipBody: 'The biggest jets usually arrive then for the best action.',
  ...
  },
  {
    ...
    copy: {
      en: {
        ...
        localTipTitle: 'Go mid-morning',
        localTipBody: 'The light hits the cave then and makes it glow brightest.',
  ...
  },
  {
    ...
    copy: {
      en: {
        ...
        localTipTitle: 'Choose the morning tour',
        localTipBody: 'It is noticeably cooler and far less crowded than midday.',
