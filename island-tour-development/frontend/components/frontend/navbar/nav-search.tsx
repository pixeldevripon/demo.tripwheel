                    ...
                    <form
                        ...
                        <span className='relative flex-1 min-w-0'>
                            <input
                                ...
                                aria-label={nav.search}
                                className='w-full bg-transparent border-none outline-none text-[16px] md:text-[14.5px] font-medium leading-[1.6] text-it-heading placeholder:font-medium placeholder:text-it-text-muted [&::-webkit-search-cancel-button]:appearance-none tracking-[-0.012em]'
                            />
                            {rotating && query === '' && (
