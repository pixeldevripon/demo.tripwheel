    ...
    return (
        <section
            ...
            <div className='it-wrap flex flex-col'>
                <Reveal>
                    <h2 className='m-0 mb-7 text-center font-it-display text-[clamp(20px,2.4vw,26px)] font-bold leading-[1.2] tracking-[-0.013em] text-it-ink'>
                        {dict.nextTitle}
                    </h2>
                </Reveal>
                    ...
                    <div
                        ...
                        {steps.map((step, i) => (
                            <Fragment key={step.title}>
                                ...
                                <span className='grid size-[34px] place-items-center rounded-it-full border-2 border-it-border bg-it-white text-[14px] font-bold text-it-text-muted tabular-nums'>
                                    {i + 1}
                                </span>
                            </Fragment>
                        ))}
                    ...
                    {steps.map((step, i) => (
                        <Reveal key={step.title} listItem>
                            ...
                            <div className='relative h-full rounded-it-md border border-it-divider bg-it-white py-[18px] pl-[58px] pr-5 shadow-it-sm md:px-5'>
                                <span className='absolute top-4 left-4 grid size-7 place-items-center rounded-it-full border-2 border-it-border bg-it-white text-[12.5px] font-bold text-it-text-muted tabular-nums md:hidden'>
                                    {i + 1}
                                </span>
