            ...
            <div className='it-container flex flex-col gap-8'>
                <MountReveal className='flex flex-col gap-4'>
                    ...
                    <div className='flex flex-col gap-1'>
                        <h1 className='m-0 font-medium text-[20px] md:text-[20px] leading-[1.2] tracking-[-0.012em] text-it-heading'>
                            {dict.manageTitle}
                        </h1>
                        <p className='m-0 text-[13px] leading-[1.6] tracking-[-0.012em] text-it-heading/60'>
                            {dict.manageSubtitle
                    ...
                    {stateNote && (
                        <p className='m-0 max-w-160 text-[13px] leading-[1.6] tracking-[-0.012em] text-it-heading/60'>
                            {stateNote}
                        </p>
                    )}
                </MountReveal>
                ...
                {booking.canReview && booking.reviewToken && (
                    <MountReveal delay={0.05}>
                        <div className='flex flex-col gap-3 rounded-[16px] border border-it-border bg-it-surface p-5 sm:flex-row sm:items-center sm:justify-between'>
                            <div className='flex flex-col gap-1'>
                                <span className='font-medium text-[13px] leading-[1.4] tracking-[-0.012em] text-it-heading'>
                                    {dict.reviewPrompt}
                                </span>
                                <span className='text-[12px] leading-[1.6] tracking-[-0.012em] text-it-heading/60'>
                            ...
                            <MotionA
                                ...
                                className='flex shrink-0 items-center justify-center rounded-full bg-it-primary px-7 py-[11px] font-medium text-[13px] leading-[1.6] tracking-[-0.012em] text-it-white no-underline transition-colors hover:bg-it-primary-hover'>
                                {dict.reviewCta}
                            </MotionA>
                        </div>
                    </MountReveal>
                    ...
                    <MountReveal
                        ...
                        {showCalendar && (
                            <MotionA
                                ...
                                <span className='font-medium text-[13px] leading-[1.6] tracking-[-0.012em] text-it-white'>
                                    {dict.addToCalendar}
                                </span>
                                <Image
                        ...
                        {canCancel && (
                            <MotionA
                                ...
                                <span className='font-medium text-[13px] leading-[1.6] tracking-[-0.012em] text-it-heading'>
                                    {dict.cancelBooking}
                                </span>
                            </MotionA>
                        )}
                ...
                {!cancelled && !cancellationPending && (
                    <MountReveal
                        delay={0.15}
                        className='text-[13px] leading-[1.6] tracking-[-0.012em] text-it-heading/60'>
                        <ResendEmailLine
