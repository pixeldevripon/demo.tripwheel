            ...
            <AnimatePresence initial={false}>
                {error && (
                    <motion.p
                        ...
                        className='m-0 text-[13px] leading-[1.5] text-it-error tracking-[-0.012em]'>
                        {error}
                    </motion.p>
                )}
            </AnimatePresence>
        ...
        <ModalShell
            ...
            <div className='shrink-0'>
                <motion.button
                    ...
                    transition={springPop}
                    className='w-full cursor-pointer rounded-it-md border-none bg-it-ink px-5 py-3 text-[14.5px] font-medium leading-[1.5] text-it-white transition-colors duration-300 hover:bg-it-primary-hover tracking-[-0.012em]'>
