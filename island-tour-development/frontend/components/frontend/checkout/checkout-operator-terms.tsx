        ...
        <div className='mt-4 flex flex-col gap-2'>
            {kind === 'ACKNOWLEDGMENT' ? (
                <div className='flex flex-col gap-2.5 rounded-it-md border-[1.5px] border-it-border bg-it-bg p-3.5'>
                    <span className='text-[12px] font-medium leading-[1.5] text-it-heading tracking-[-0.012em]'>
                    ...
                    <ul className='m-0 flex list-disc flex-col gap-1 pl-5'>
                        {items.map((item, i) => (
                            <li
                                key={i}
                                className='text-[12px] leading-[1.6] text-it-text-muted tracking-[-0.012em]'>
                                {item}
                            </li>
                        ))}
                    </ul>
            ...
            <AnimatePresence initial={false}>
                {error && (
                    <motion.p
                        ...
                        className='m-0 text-[11.5px] leading-[1.5] text-it-error tracking-[-0.012em]'>
                        {error}
                    </motion.p>
                )}
            </AnimatePresence>
        ...
        <ModalShell
            ...
            <div className='flex shrink-0 flex-col gap-4'>
                <div className='flex items-start justify-between gap-4'>
                    <div className='flex flex-col gap-1'>
                        <h2 className='m-0 font-it-display text-[19px] leading-[1.2] tracking-[-0.012em] text-it-heading sm:text-[19.5px] font-medium'>
                    ...
                    <motion.button
                        ...
                        <div className='min-h-0 flex-1 overflow-y-auto'>
                            {state === 'ready' && body?.document ? (
                                <div
                                    className='flex flex-col gap-2 text-[13.5px] leading-[1.7] text-it-text-muted [&_h4]:m-0 [&_h4]:mt-3 [&_h4]:text-[14.5px] [&_h4]:font-bold [&_h4]:leading-[1.6] [&_h4]:text-it-heading [&_h4:first-child]:mt-0 [&_li]:mt-1 [&_p]:m-0 [&_ul]:m-0 [&_ul]:pl-5 tracking-[-0.012em]'
                              ...
                              (state === 'ready' && !body?.document) ? (
                                <p className='m-0 text-[13px] leading-[1.6] text-it-text-muted tracking-[-0.012em]'>
            ...
            <div className='shrink-0'>
                <motion.button
                    ...
                    transition={springPop}
                    className='w-full cursor-pointer rounded-it-md border-none bg-it-primary px-5 py-3 text-[13.5px] font-medium leading-[1.5] text-it-white transition-colors duration-300 hover:bg-it-primary-hover tracking-[-0.012em]'>
