...
function SubBlock({
    ...
    return (
        <div className='flex flex-col px-5 py-[18px]'>
            <h3 className='m-0 mb-1.5 flex items-center gap-[9px] text-[14px] leading-[1.6] text-it-heading font-medium tracking-[-0.012em]'>
                <Image
                    src={icon}
                    alt=''
                    width={24}
            ...
            {(info.title || info.detail) && (
                <p className='m-0 whitespace-pre-line text-[13px] leading-[1.6] text-it-heading tracking-[-0.012em]'>
            ...
            <SubBlock icon='/icons/qi-pin.svg' info={meeting}>
                {mapLink && (
                    <MotionA
                        ...
                        className='mt-2 flex w-fit items-center gap-[7px] text-[14.5px] font-medium leading-[1.6] text-it-primary hover:text-it-primary-hover underline underline-offset-[3px] transition-colors duration-300 tracking-[-0.012em]'>
                        <Image
