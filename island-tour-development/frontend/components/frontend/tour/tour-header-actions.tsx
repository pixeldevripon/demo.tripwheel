...
export function TourHeaderActions({
    ...
    const actionClass = overlay
        ...
        : 'inline-flex cursor-pointer items-center gap-[7px] rounded-it-full border border-it-border bg-it-white px-3.5 py-2 text-[13px] font-medium leading-[1.2] text-it-heading transition-colors duration-(--it-duration-xs) ease-(--it-ease) hover:bg-it-bg';
