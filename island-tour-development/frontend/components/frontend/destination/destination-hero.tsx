            ...
            <div className='it-container w-full flex justify-center'>
                ...
                <div className='relative z-10 flex w-full max-w-[680px] flex-col items-center gap-7'>
                    ...
                    <div className='flex flex-col items-center gap-3 text-center'>
                        <h1 className='m-0 font-it-display font-extrabold text-[clamp(31px,3.8vw,48px)] leading-[1.04] tracking-[-0.02em] text-balance text-it-white [text-shadow:0_2px_22px_rgba(0,0,0,0.32)]'>
