...
> = {
  ...
  likelyToSellOut: { className: 'bg-[#193c5e] text-white', label: 'Likely to sell out' },
  // Figma: bg #e8611a, text white
  mostPopular: { className: 'bg-[#e8611a] text-white', label: 'Most popular' },
};
...
export function TourBadgeChip({
  ...
  return (
    <span
      className={[
        'inline-flex shrink-0 items-center justify-center rounded-full font-normal leading-[1.4] tracking-[-0.012em]',
        sizeClass,
        style.className,
        className,
      ].join(' ')}
