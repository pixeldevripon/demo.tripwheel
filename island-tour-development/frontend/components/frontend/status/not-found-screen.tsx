                ...
                <div className='it-container w-full py-14 md:py-20'>
                    <div
                        ...
                        <div>
                            ...
                            <span
                                aria-hidden
                                className='block font-it-display font-bold text-[clamp(84px,11vw,138px)] leading-[0.92] tracking-[-2px] text-it-peach-border select-none'>
                                404
                            </span>

                            <h1 className='m-0 mt-2.5 font-it-display font-bold text-[clamp(34px,4.4vw,52px)] leading-[1.05] tracking-[-0.5px] text-it-ink'>
                                {copy.title}
                            </h1>
                    ...
                    <div className='it-container'>
                        <Reveal>
                            <div className='mb-8 flex flex-wrap items-end justify-between gap-x-6 gap-y-4 md:mb-10'>
                                <div>
                                    <h2 className='m-0 font-it-display text-[27px] font-bold leading-[1.2] tracking-[-0.3px] text-it-ink'>
                                        {copy.popularTitle}
                                    </h2>
