...
export function EditorialBanner({
    ...
    return (
        <section className='it-section bg-it-white overflow-x-clip sm:pt-0!'>
                ...
                <Reveal className='relative lg:min-h-[372px]'>
                    ...
                    <div className='relative flex flex-col gap-6 px-6 py-10 sm:px-10 sm:py-12 lg:block lg:min-h-[372px] lg:p-0'>
                        ...
                        <div className='flex flex-col lg:absolute lg:left-[60px] lg:top-1/2 lg:z-3 lg:-translate-y-1/2 lg:max-w-[432px]'>
                            <h2 className='m-0 font-it-display text-[26px] sm:text-[26px] leading-[1.15] tracking-[-0.012em] text-it-white font-medium'>
                                <span className='block'>{dict.titleLine1}</span>
                                <span className='block tracking-[-0.012em]'>
                                    {dict.titleLine2}
                                </span>
                            </h2>
                            <p className='m-0 mt-3.5 max-w-[400px] it-text text-it-white/80'>
                                {dict.body}
                            </p>
                            ...
                            <MotionLink
                                ...
                                <span className='font-medium text-[14.5px] leading-[1.6] text-it-primary tracking-[-0.012em]'>
                                    {dict.cta}
                                </span>
                                <MotionSpan
                                    ...
                                    transition={springPop}>
                                    <ArrowRight
                                        className='size-4 text-it-primary-hover tracking-[-0.012em]'
                                        strokeWidth={2.2}
                                    />
                                </MotionSpan>
                            </MotionLink>
