            ...
            <div className='it-container'>
                <Reveal className='flex flex-col gap-[18px]'>
                    <div className='flex flex-col gap-1.5'>
                        <h2 className='m-0 text-[clamp(22px,2.6vw,30px)] leading-[1.1] tracking-[-0.015em] text-it-ink font-medium'>
                            {dict.title}
                        </h2>
                        {dict.subtitle && (
                            ...
                            <Reveal key={island.slug} width='auto' listItem>
                                <MotionLink
                                    ...
                                    <div className='flex flex-col px-4 pt-3.5 pb-4'>
                                        <span className='font-it-display font-medium text-[20px] leading-[1.3] tracking-[-0.01em] text-it-ink'>
                                            {island.name}
                                        </span>
