            ...
            <div className='it-container'>
                <Reveal className='flex flex-col gap-[18px]'>
                    <div className='flex flex-col gap-1.5'>
                        <h2 className='m-0 text-[clamp(22px,2.6vw,30px)] leading-[1.1] tracking-[-0.015em] text-it-ink font-bold'>
                            {dict.title}
                        </h2>
                        {dict.subtitle && (
                            ...
                            <Reveal key={island.slug} width='auto' listItem>
                                <MotionLink
                                    ...
                                    <div className='flex flex-col px-4 pt-3.5 pb-4'>
                                        ...
                                        <span className='text-[13px] font-bold leading-[1.6] text-it-text-muted tabular-nums'>
