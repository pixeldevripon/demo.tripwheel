            ...
            <div className='it-container'>
                <Reveal className='relative flex min-h-[300px] items-center justify-center overflow-hidden rounded-it-lg text-center'>
                    ...
                    <div className='relative z-2 px-6 py-14 md:px-8 md:py-16 text-it-ink-on-dark'>
                        <h2 className='m-0 text-[clamp(24px,3vw,34px)] leading-[1.06] tracking-[-0.015em] font-medium text-it-ink-on-dark'>
                            {dict.title}
                        </h2>
                        ...
                        <MotionLink
                            href={ctaHref}
                            className='mt-6 inline-flex items-center gap-2 rounded-it-sm bg-it-primary px-7 py-3.5 no-underline cursor-pointer border-none text-[17px] md:text-[19px] font-medium text-it-white transition-colors hover:bg-it-primary-hover'
                            initial='rest'
                            animate='rest'
                            whileTap='tap'
                            variants={{
                            ...
                            <MotionSpan
                                ...
                                transition={springPop}>
                                <ArrowRight
                                    className='size-4.5 text-it-white'
                                    strokeWidth={2}
                                />
                            </MotionSpan>
                        </MotionLink>
