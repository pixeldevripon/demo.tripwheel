            ...
            {open && (
                <motion.div
                    ...
                    <motion.div
                        ...
                        <p className='m-0 text-[17px] font-bold leading-[1.4] tracking-[-0.012em] text-it-heading'>
                            {title}
                        </p>
                        {body && (
                        ...
                        <div className='mt-5 flex flex-wrap items-center gap-2.5'>
                            <motion.button
                                ...
                                whileTap={{ scale: 0.97 }}
                                onClick={onConfirm}
                                className={`cursor-pointer rounded-full px-4.5 py-2.25 text-[14px] font-semibold transition-colors disabled:cursor-default disabled:opacity-60 ${
                                    destructive
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.97 }}
                                onClick={onClose}
                                className='cursor-pointer rounded-full border-none bg-transparent px-4.5 py-2.25 text-[14px] font-semibold text-it-text-muted transition-colors hover:text-it-heading disabled:cursor-default disabled:opacity-60'>
                                {cancelLabel}
                            </motion.button>
                        </div>
                    </motion.div>
