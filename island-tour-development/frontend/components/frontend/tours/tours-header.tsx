...
export async function ToursHeader({
    ...
    return (
        ...
        <div className='flex flex-col'>
            <h1 className='m-0 text-[26px] md:text-[38px] leading-[1.2] tracking-[-0.012em] text-it-heading font-medium'>
                {title}
            </h1>
            <p className='m-0 mt-2 max-w-[640px] it-text text-it-text-muted'>
                {subtitle}
            </p>
            <p className='m-0 mt-1.5 text-[12px] leading-[1.6] text-it-text-muted tabular-nums tracking-[-0.012em]'>
