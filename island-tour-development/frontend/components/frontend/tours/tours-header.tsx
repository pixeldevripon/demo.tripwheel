...
export async function ToursHeader({
    ...
    return (
        ...
        <div className='flex flex-col'>
            <h1 className='m-0 text-[31px] md:text-[44.5px] leading-[1.2] tracking-[-0.012em] text-it-heading font-medium'>
                {title}
            </h1>
            <p className='m-0 mt-2 max-w-[640px] text-[13px] md:text-[14.5px] leading-[1.6] text-it-text-muted tracking-[-0.012em]'>
                {subtitle}
            </p>
            <p className='m-0 mt-1.5 text-[11.5px] leading-[1.6] text-it-text-muted tabular-nums tracking-[-0.012em]'>
