                ...
                <Reveal className='flex flex-wrap items-center justify-between gap-[18px]'>
                    <div className='flex flex-wrap gap-x-[22px] gap-y-2.5 max-md:flex-col'>
                        {dict.checks.map(check => (
                            <span
                                key={check}
                                className='flex items-center gap-2 text-[13px] md:text-[14.5px] leading-[1.6] text-it-heading tracking-[-0.012em]'>
                                <Image
                    ...
                    {whatsappUrl && (
                        <a
                            ...
                            className='whitespace-nowrap text-[12.5px] font-medium leading-[1.6] text-it-primary-hover underline underline-offset-[3px] transition-colors duration-300 hover:text-it-primary tracking-[-0.012em]'>
                            {dict.whatsapp}
                        </a>
                    )}
                </Reveal>
