...
function OptChip({
    ...
    return (
        <motion.button
            ...
            className={`cursor-pointer whitespace-nowrap rounded-it-full border px-[15px] py-2 text-[12px] leading-[1.6] transition-colors duration-(--it-duration-xs) ease-(--it-ease) ${
                on
...
function Section({
    ...
    return (
        <div className='flex flex-col border-b border-it-divider py-4 last:border-b-0'>
            {title && (
                <h4 className='m-0 mb-3 text-[13px] leading-[1.6] text-it-heading font-medium tracking-[-0.012em]'>
                    {title}
                </h4>
            )}
            {children}
                    ...
                    <motion.div
                        ...
                        <div className='it-modal-scroll min-h-0 flex-1 px-6 pb-1 pt-2'>
                            ...
                            <Section title={dict.price}>
                                ...
                                />
                                <div className='flex items-center justify-between text-[14.5px] leading-[1.6] text-it-text-muted tabular-nums tracking-[-0.012em]'>
                                    <span>
                                        {formatPriceFrom(
                                            draft.price[0],
                                            currency,
                            ...
                            <Section title={dict.freeCancellation}>
                                <p className='-mt-2 mb-3 text-[12px] leading-[1.6] text-it-text-muted tracking-[-0.012em]'>
                            ...
                            <Section>
                                <div className='flex items-center justify-between gap-4'>
                                    <div>
                                        <h4 className='m-0 mb-1 text-[13px] leading-[1.6] text-it-heading font-medium tracking-[-0.012em]'>
                                            {dict.pickupAvailable}
                                        </h4>
                                        <p className='m-0 max-w-[380px] text-[13px] leading-[1.6] text-it-text-muted tracking-[-0.012em]'>
                                            {dict.pickupNote}
                                        </p>
                                    </div>
                                    <Toggle
