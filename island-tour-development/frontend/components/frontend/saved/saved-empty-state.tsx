...
export function SavedEmptyState({
    ...
    return (
        <div className='flex flex-col'>
            ...
            <h1 className='m-0 mt-3.5 font-it-display text-[clamp(24px,3.45vw,31px)] leading-[1.15] tracking-[-0.012em] text-it-heading font-medium'>
                {dict.title}
            </h1>
            <p className='m-0 mt-2 max-w-[520px] text-[14.5px] leading-[1.6] text-it-text-muted tracking-[-0.012em]'>
                {dict.body}
            </p>
            ...
            {island && (
                <Link
                    ...
                    className='mt-[18px] w-fit rounded-it-full bg-it-primary px-[22px] py-[13px] text-[13px] font-medium leading-[1.6] text-it-white no-underline transition-colors duration-(--it-duration-xs) ease-(--it-ease) hover:bg-it-primary-hover tracking-[-0.012em]'>
            ...
            {!island && (
                <Link
                    ...
                    className='mt-[18px] w-fit rounded-it-full bg-it-primary px-[22px] py-[13px] text-[13px] font-medium leading-[1.6] text-it-white no-underline hover:bg-it-primary-hover tracking-[-0.012em]'>
                ...
                <div className='mt-[26px] flex flex-wrap gap-[9px]'>
                    {island.categories.map(category => (
                        <Link
                            ...
                            className='rounded-it-full border border-it-border bg-it-white px-[15px] py-[9px] text-[12px] font-medium leading-[1.6] text-it-heading no-underline transition-colors duration-(--it-duration-xs) ease-(--it-ease) hover:border-it-ink tracking-[-0.012em]'>
                            {category.name}
                        </Link>
                    ))}
                </div>
