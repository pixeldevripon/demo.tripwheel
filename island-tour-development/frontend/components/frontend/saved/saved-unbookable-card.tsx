    ...
    return (
        <article
            ...
            <div className='flex flex-1 min-w-0 flex-col gap-1 px-3 pt-2.5 pb-3 @[220px]:px-3.5 @[220px]:pt-3 @[220px]:pb-3.5'>
                ...
                <p className='m-0 mt-1 text-[12px] font-medium leading-[1.6] text-it-text-muted tracking-[-0.012em]'>
                    {dict.notBookable}
                </p>
                {similarHref && (
                    <Link
                        href={similarHref}
                        className='mt-1.5 w-fit text-[12px] font-medium leading-[1.6] text-it-primary-hover underline underline-offset-[3px] tracking-[-0.012em]'>
