...
export function SavedEmailBox({
    ...
    return (
        <div className='rounded-it-lg bg-it-bg px-[22px] py-5'>
            <b className='block font-it-display text-[17px] font-medium leading-[1.3] text-it-heading tracking-[-0.012em]'>
                {dict.title}
            </b>
            ...
            <form onSubmit={handleSubmit} noValidate className='mt-3 flex gap-2'>
                <input
                    ...
                    className={cn(
                        'min-w-0 flex-1 rounded-it-sm border bg-it-white px-[13px] py-[11px] font-it-body text-[13.5px] leading-[1.6] text-it-heading outline-none tracking-[-0.012em]',
                        fieldError
