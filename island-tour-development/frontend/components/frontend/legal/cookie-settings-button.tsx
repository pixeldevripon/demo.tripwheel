    ...
    return (
        <div className='my-6 flex flex-col items-start gap-3'>
            <button
                ...
                className='inline-flex cursor-pointer items-center rounded-full border-none bg-it-primary px-6 py-3 text-[15px] font-normal text-it-primary-fg transition-colors hover:bg-it-primary-hover active:bg-it-primary-active'>
