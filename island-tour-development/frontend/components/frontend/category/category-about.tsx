        ...
        <section className='bg-it-white'>
            <div className='it-container'>
                <Reveal className='flex max-w-[760px] flex-col gap-3'>
                    <h2 className='m-0 mt-13 font-it-display text-[22px] font-medium leading-[1.2] tracking-[-0.013em] text-it-ink'>
                        {title}
                    </h2>
                    ...
                    <AboutExpander
                        ...
                        buttonClassName='ml-1.5 inline cursor-pointer border-none bg-transparent p-0 text-[14.5px] font-medium leading-[1.7] text-it-primary-hover underline underline-offset-[3px] transition-colors duration-300 hover:text-it-primary'
                    />
                </Reveal>
            </div>
        </section>
