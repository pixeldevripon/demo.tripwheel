            ...
            render={({ slots }) => (
                <>
                    {slots.map((slot, i) => (
                        <div
                            key={i}
                            className={`relative flex h-12 flex-1 items-center justify-center rounded-[12px] border bg-it-white text-[22px] leading-none font-medium tracking-[-0.012em] text-it-heading transition-colors  sm:text-[24px] ${
                                slot.isActive
