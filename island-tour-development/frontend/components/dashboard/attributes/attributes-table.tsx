...
import { SearchIcon, Settings2Icon, DatabaseIcon, ChevronLeftIcon, ChevronRightIcon, ChevronsLeftIcon, ChevronsRightIcon } from 'lucide-react';
          ...
          <TableBody>
            {table.getRowModel().rows.length === 0 ? (
              ...
              table.getRowModel().rows.map((row) => (
                <TableRow
                  key={row.id}
                  className={row.original.isActive ? undefined : 'opacity-50'}
                >
