...
export default function PortalLayout({
    ...
    return (
        <div className='grid min-h-screen grid-cols-1 md:grid-cols-2'>
            ...
            <aside className='relative hidden flex-col justify-between overflow-hidden bg-linear-[155deg,#2E86AB_0%,#1B5E7E_55%,#123F55_100%] px-10 py-9 text-white md:flex'>
                ...
                <div className='relative z-10'>
                    <h2 className='max-w-95 font-it-display text-[26px] font-semibold leading-[1.3] tracking-[-0.01em] text-white!'>
                        Your tours, availability, and bookings. One place, every day.
                    </h2>
                    <p className='mt-2.5 max-w-90 text-[14.5px] opacity-85'>
            ...
            <main className='flex flex-col items-center justify-center bg-it-bg px-6 py-10'>
