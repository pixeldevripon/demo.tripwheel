            ...
            <body>
                ...
                <div className='frontend-root it-status-surface flex min-h-svh items-center'>
                    <div className='it-container flex w-full flex-col items-center py-20 text-center md:py-28'>
                        ...
                        <span className='mb-5 inline-flex items-center rounded-it-full bg-it-surface px-4 py-2 text-[12px] font-medium leading-none tracking-[-0.012em] text-it-ink-secondary'>
                            {copy.eyebrow}
                        </span>

                        <h1 className='m-0 max-w-175 font-medium text-[27px] md:text-[38.5px] leading-[1.2] tracking-[-0.012em] text-it-heading'>
                            {copy.title}
                        </h1>

                        <p className='m-0 mt-4 max-w-150 text-[14.5px] md:text-[16.5px] leading-[1.6] tracking-[-0.012em] text-it-text-muted'>
                            {copy.description}
                        </p>
                        ...
                        <div className='mt-10 flex w-full flex-col items-stretch gap-3 sm:w-auto sm:flex-row sm:items-center sm:gap-4'>
                            <button
                                ...
                                className='inline-flex cursor-pointer items-center justify-center rounded-it-full border-none bg-it-primary px-8 py-[15px] text-[14.5px] font-medium leading-[1.6] tracking-[-0.012em] text-it-white transition-colors duration-300 hover:bg-it-primary-hover md:px-10'>
                                {copy.primaryCta}
                            </button>
                            <a
                                href='/'
                                className='inline-flex cursor-pointer items-center justify-center rounded-it-full border border-it-ink bg-transparent px-8 py-[15px] text-[14.5px] font-medium leading-[1.6] tracking-[-0.012em] text-it-heading no-underline transition-colors duration-300 hover:bg-it-ink hover:text-it-white md:px-10'>
                                {copy.secondaryCta}
                            </a>
                        </div>
