        ...
        <section className='it-section bg-it-white'>
            <div className='it-container'>
                <div className='mx-auto max-w-[720px]'>
                    <h1 className='m-0 font-it-display text-[26px] leading-[1.2] tracking-[-0.012em] text-it-heading sm:text-[26px] font-medium'>
                        {dict.checkout.operatorTermsReaderTitle}
                    </h1>
                    <p className='mb-6 mt-2 text-[12px] leading-[1.6] text-it-text-muted tracking-[-0.012em]'>
                        {versionLine}
                    </p>
