 ...
 *
 * Covers:
 *  1. Trip List Page (/dashboard/trips)
 ...
 *
 *  2. Create Trip (/dashboard/trips/new)
...
test.describe('Trip List Page (/dashboard/trips)', () => {
...
test.describe('Create Trip (/dashboard/trips/new)', () => {
  test.beforeEach(async ({ page }) => {
    await mockSupportingData(page);
  ...
  test('successful create navigates to edit page', async ({ page }) => {
    ...
    await expect(page).toHaveURL(/\/dashboard\/trips\/new-trip-id\/edit/, { timeout: 10_000 });
  });
...
test.describe('Edit Trip — Details Tab', () => {
  ...
  test('LIVE trip shows Pause and Archive buttons (not Publish)', async ({ page }) => {
    ...
    await page.goto(`/dashboard/trips/${LIVE_TRIP_ID}/edit?tab=details`);
    await page.waitForSelector('input[name="name"]', { timeout: 15_000 });
...
test.describe('Edit Trip — Inclusions Tab', () => {
  test.beforeEach(async ({ page }) => {
    ...
    await page.goto(`/dashboard/trips/${TRIP_ID}/edit?tab=inclusions`);
...
test.describe('Edit Trip — Schedules Tab', () => {
  test.beforeEach(async ({ page }) => {
    ...
    await page.goto(`/dashboard/trips/${TRIP_ID}/edit?tab=schedules`);
...
test.describe('Edit Trip — Translations Tab', () => {
  test.beforeEach(async ({ page }) => {
    ...
    await page.goto(`/dashboard/trips/${TRIP_ID}/edit?tab=translations`);
...
test.describe('Trip Lifecycle', () => {
  test('DRAFT trip: Publish button calls POST /publish', async ({ page }) => {
    ...
    await page.goto(`/dashboard/trips/${TRIP_ID}/edit`);
  ...
  test('LIVE trip: Pause button calls POST /pause', async ({ page }) => {
    ...
    await page.goto(`/dashboard/trips/${LIVE_TRIP_ID}/edit`);
  ...
  test('PAUSED trip shows Unpause button', async ({ page }) => {
    ...
    await page.goto(`/dashboard/trips/paused-id/edit`);
