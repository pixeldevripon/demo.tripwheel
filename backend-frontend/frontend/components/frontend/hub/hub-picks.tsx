    ...
    return (
        <Reveal className='flex flex-col gap-10 md:gap-12'>
            <div className='flex flex-col gap-1'>
                <h3 className='m-0 text-[20px] md:text-[26px] leading-[1.2] tracking-[-0.012em] text-it-heading font-medium'>
                    {data.title}
                </h3>
            ...
            <p className='m-0 text-left it-text md:text-center text-it-text-muted'>
                {data.footerNote}
            </p>
        </Reveal>
    );
