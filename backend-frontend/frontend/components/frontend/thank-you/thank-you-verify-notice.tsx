                    ...
                    <div className='flex flex-col items-start gap-5 rounded-[16px] border border-it-heading/10 bg-it-surface p-6 sm:flex-row sm:items-center sm:justify-between'>
                        <div className='flex items-start gap-4'>
                            ...
                            <div className='flex flex-col gap-1'>
                                <p className='m-0 font-medium text-[13px] leading-[1.6] tracking-[-0.012em] text-it-heading'>
                                    {dict.verifyTitle}
                                </p>
                                <p className='m-0 text-[12px] leading-[1.6] tracking-[-0.012em] text-it-text-muted'>
                                    {dict.verifyBody}
                                </p>
                            </div>
                        </div>
                        <MotionA
                            ...
                            className='shrink-0 rounded-full bg-it-primary px-7 py-3 font-medium text-[13px] leading-[1.6] tracking-[-0.012em] text-it-white transition-colors hover:bg-it-primary-hover'>
                            {dict.verifyCta}
                        </MotionA>
                    </div>
                </MountReveal>
