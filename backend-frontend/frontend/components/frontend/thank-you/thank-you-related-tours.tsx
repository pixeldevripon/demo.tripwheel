            ...
            <div className='it-container flex flex-col'>
                ...
                <Reveal className='mt-6'>
                    <MotionLink
                        ...
                        className='inline-block text-[13px] font-medium leading-[1.6] text-it-primary-hover underline underline-offset-[3px] transition-colors duration-300 hover:text-it-primary tracking-[-0.012em]'>
                        {dict.browsePicks} →
                    </MotionLink>
                </Reveal>
            </div>
