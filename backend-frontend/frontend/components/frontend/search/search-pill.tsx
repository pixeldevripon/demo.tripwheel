    ...
    const dateButton = (
        <motion.button
            ...
            className={`flex min-w-0 flex-1 cursor-pointer items-center gap-2 whitespace-nowrap rounded-it-full border-none bg-transparent py-2.5 pl-2.5 pr-1 text-left leading-[1.6] transition-colors hover:bg-it-bg ${
                compact ? 'text-[13px] tracking-[-0.012em]' : 'text-[14.5px] tracking-[-0.012em]'
            ...
            <label
                ...
                <span className='relative min-w-0 flex-1'>
                    <input
                        ...
                        className='min-w-0 w-full border-none bg-transparent text-[16px] font-medium leading-[1.6] text-it-heading outline-none placeholder:font-medium placeholder:text-it-text-muted md:text-[14.5px] [&::-webkit-search-cancel-button]:appearance-none tracking-[-0.012em]'
                    />
                    {children}
                </span>
            </label>
