...
export const inputClass =
    'w-full rounded-[10px] border border-it-border bg-it-white px-3.5 py-2.75 text-[16px] md:text-[14.5px] text-it-heading placeholder:text-it-ink-placeholder focus:border-transparent focus:outline-2 focus:outline-it-primary tracking-[-0.012em]';
...
export const primaryBtn =
    'flex w-full items-center justify-center gap-2 rounded-full bg-it-primary px-5 py-3.25 text-[13px] font-medium text-it-primary-fg transition-[filter] hover:brightness-95 tracking-[-0.012em]';

export const quietLink =
    'text-[12px] font-medium text-it-text-muted transition-colors hover:text-it-primary tracking-[-0.012em]';
...
export function ErrorNote({ children }: { children: React.ReactNode }) {
    return (
        <div
            role='alert'
            className='mb-4 flex items-start gap-2 rounded-[10px] border border-red-200 bg-red-50 px-3.25 py-2.5 text-[12px] text-red-700 tracking-[-0.012em]'>
...
export function SuccessBlock({
    ...
    return (
        <div className='py-2 text-center'>
            ...
            <strong className='block text-[14.5px] text-it-heading tracking-[-0.012em]'>{title}</strong>
