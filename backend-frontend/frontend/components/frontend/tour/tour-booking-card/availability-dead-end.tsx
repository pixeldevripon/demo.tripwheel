            ...
            <MountReveal listItem yOffset={8} duration={0.35}>
                <MotionLink
                    ...
                    <span className='flex min-w-0 flex-1 flex-col gap-0.5'>
                        <span className='truncate font-medium text-[13px] leading-[1.4] tracking-[-0.012em] text-it-heading'>
                            {alt.title}
                        </span>
                    ...
                    <span className='shrink-0 font-medium text-[13px] leading-[1.4] tracking-[-0.012em] text-it-heading'>
                        {priceDisplay}
                    </span>
                </MotionLink>
            </MountReveal>
