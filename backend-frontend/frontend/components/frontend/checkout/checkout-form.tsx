        ...
        <div
            ...
            {paymentFailed && (
                <div className='px-[22px] pt-[18px]'>
                    <div className='rounded-it-sm border border-it-primary/30 bg-it-primary-subtle px-3.5 py-3 text-[13px] leading-[1.6] text-it-primary-hover tracking-[-0.012em]'>
                        {dict.paymentError}
                    </div>
                </div>
            )}
                    ...
                    <div className='flex flex-col gap-4'>
                            ...
                            {lockedEmail ? (
                                <span
                                    ...
                                    <button
                                        ...
                                        className='cursor-pointer border-none bg-transparent p-0 font-medium text-it-primary underline underline-offset-2 tracking-[-0.012em]'>
                        ...
                        <div className='flex flex-col gap-1.5'>
                            ...
                            <textarea
                                ...
                                className='h-[70px] w-full resize-none rounded-it-sm border border-it-border bg-it-white px-[13px] py-[11px] text-[16px] md:text-[14.5px] leading-[1.5] text-it-heading placeholder:text-it-text-muted outline-none transition-colors focus:border-it-primary tracking-[-0.012em]'
                            />
                        ...
                        <AnimatePresence initial={false}>
                            {!contactDone && (
                                <motion.span
                                    ...
                                    exit={{ opacity: 0 }}
                                    transition={{ duration: 0.2 }}
                                    className='ml-auto text-right text-[13px] leading-[1.6] text-it-text-muted tracking-[-0.012em]'>
