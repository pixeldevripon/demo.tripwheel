...
export function TravellerReceiptPrintButton({ label }: { label: string }) {
    return (
        <button
            ...
            className='inline-flex cursor-pointer items-center gap-2 rounded-full bg-it-primary px-5 py-2.5 text-[13px] font-medium text-it-primary-fg transition-[filter] hover:brightness-95 tracking-[-0.012em]'>
