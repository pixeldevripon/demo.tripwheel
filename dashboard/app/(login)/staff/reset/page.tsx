...
import { StaffReset } from '@/components/login/staff-reset';

export const metadata: Metadata = {
    title: 'Set your password | Island Tours staff',
...
export default function StaffResetPage({
    ...
    // dynamic access must sit inside a <Suspense> boundary so the static staff
...
async function ResetCard({
    ...
    return <StaffReset expired={state === 'expired'} />;
}
