 ...
 */
export default function LocalsFavouritesLoading() {
    return (
        <ListPageSkeleton
            title="Locals' Favourites"
            description='Curate the editorial Locals\u2019 favourite flag. Manual selection only - never tier-linked. Target ~30% of live tours.'
            columns={7}
            filters={2}
        />
    );
