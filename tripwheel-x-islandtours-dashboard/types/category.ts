...
export interface UpdateCategoryPayload {
    ...
    parentCategoryId?: string | null;
    /**
     * Required (true) when demoting a top-level category into a sub-category
     * (attach-existing): accepts that Its standalone page will be removed on every
     * destination (slug retired with the 90-day cooldown). Seeded categories
