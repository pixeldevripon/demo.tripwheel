...
function FaqLocaleEditor({
    ...
    const { mutate: upsert, isPending } = useUpsertFaqTranslation(
        basePath,
        entityId
    );
        ...
        upsert(
            {
                groupId,
                locale,
                payload: { question: values.question, answer: values.answer },
            },
            {
                onSuccess: () =>
...
function FaqGroupCard({ basePath, entityId, group }: FaqGroupCardProps) {
    ...
    const { mutate: updateGroup, isPending: isUpdating } = useUpdateFaqGroup(
        basePath,
        entityId
    );
    const { mutate: deleteGroup, isPending: isDeleting } = useDeleteFaqGroup(
        basePath,
        entityId
    );
            ...
            <AlertDialog open={deleteOpen} onOpenChange={setDeleteOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            This deletes the FAQ and all of its translations.
...
function AddFaqForm({
    ...
    return (
        <form
            ...
            <FieldDescription>
                Add the FAQ in English first, then expand it to translate into
                other languages.
            </FieldDescription>
            <div className='flex justify-end'>
                <Button type='submit' size='sm' disabled={isPending}>
        ...
        <div className='space-y-4'>
            {isLoading ? (
                ...
                <div className='flex flex-col items-center gap-3 py-16 text-muted-foreground'>
                    ...
                    <p className='text-xs'>
                        Add your first FAQ in English below.
                    </p>
                </div>
            ) : (
                <div className='space-y-3'>
