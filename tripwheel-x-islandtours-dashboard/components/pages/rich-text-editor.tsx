  ...
  return (
    <div className="it-page-editor">
      <div className="it-page-editor-toolbar">
        ...
        >
          ...
          <PopoverContent className="w-80" align="start">
            <div className="flex flex-col gap-2">
              ...
              />
              {linkDraft.trim() && !isAllowedHref(linkDraft.trim()) && (
        ...
        {(
          [
            { dir: 'left', active: state.alignLeft, icon: TextAlignLeftIcon },
            {
              dir: 'center',
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="start">
            ...
            >
              <HugeiconsIcon icon={ColumnInsertIcon} /> Add column right
            </DropdownMenuItem>
            <DropdownMenuItem
              disabled={!state.inTable}
              onClick={() => editor.chain().focus().deleteColumn().run()}
            >
              <HugeiconsIcon icon={ColumnDeleteIcon} /> Delete column
            </DropdownMenuItem>
            <DropdownMenuItem
              disabled={!state.inTable}
