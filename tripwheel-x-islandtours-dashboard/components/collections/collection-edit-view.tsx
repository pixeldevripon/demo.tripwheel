...
export function CollectionEditView({
    ...
    const readinessChecks = [
        ...
        ...(isManual
            ? [{ label: 'At least 1 member tour', passed: memberCount >= 1 }]
            : []),
    ];
            ...
            <div className='space-y-6'>
                ...
                <div className='flex flex-wrap items-center justify-between gap-3'>
                    <div className='flex items-center gap-3'>
                        ...
                        <StatusBadge
                            variant={
                                COLLECTION_STATUS[collection.status].variant
                            }
                        ...
                        <CardContent className='pt-4 space-y-3'>
                            ...
                            {isManual && (
                                <div className='flex items-start gap-2 text-xs text-muted-foreground border-t pt-3'>
                                    ...
                                    />
                                    <span>
                                        Every member tour also needs an English
                                        rationale (≤20 words), set in the Tours
                                        tab. This is enforced by the server on
                                        publish.
                                    </span>
                                </div>
                            )}
