    ...
    <Card>
      ...
      <CardContent className="pt-8">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <Field>
              <div className="flex items-center gap-2">
                ...
                <Label htmlFor="isFilterable" className="cursor-pointer">Filterable</Label>
              </div>
            ...
            <Field>
              <div className="flex items-center gap-2">
                ...
                <Label htmlFor="isSortable" className="cursor-pointer">Sortable</Label>
              </div>
          ...
          <Field>
            <Label>Filter Display Type</Label>
            <Select
